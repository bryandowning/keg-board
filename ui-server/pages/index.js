...
export default function Index() {
  const beers = [
    ...
    },
    {
      ...
      notes:
        "Slightly modified Janet's Brown recipe, adapted for liquid malt extract and a less agressive hop schedule",
      og: 1.062,
      fg: 1.012,
      srm: 19,
      ibu: 31,
  ...
  const rows = beers.map((beer) => <BeerRow key={beer.id} beer={beer} />);
